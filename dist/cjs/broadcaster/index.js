...
const error_js_1 = require("../error.d.ts");
const provider_js_1 = require("../provider.d.ts");
const index_js_1 = require("../transaction");
const index_js_2 = require("../utils");
const simulateTransactionWithCommitment_js_1 = require("../utils/simulateTransactionWithCommitment.d.ts");
const sendAndSpamRawTx_js_1 = require("./sendAndSpamRawTx.d.ts");
tslib_1.__exportStar(require("./tiered.d.ts"), exports);
/**
