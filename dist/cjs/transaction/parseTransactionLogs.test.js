...
const parseTransactionLogs_js_1 = require("./parseTransactionLogs.d.ts");
describe("parseTransactionLogs", () => {
    it("should parse the logs", () => {
        ...
        const result = (0, parseTransactionLogs_js_1.parseTransactionLogs)(logs, null);
...
//# sourceMappingURL=parseTransactionLogs.test.js.map
