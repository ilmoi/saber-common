...
import { COMPUTE_BUDGET_PROGRAM } from "./index.d.ts";
import { RequestHeapFrameLayout, RequestUnitsLayout } from "./layouts.d.ts";
/**
 * Request a specific maximum number of compute units the transaction is
 * allowed to consume and an additional fee to pay.
 */
export const requestComputeUnitsInstruction = (units, additionalFee) => {
 ...
 */
export const requestHeapFrameInstruction = (bytes) => {
